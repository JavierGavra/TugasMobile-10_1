...
public class LuasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Tombol Back
        btn_back = findViewById(R.id.btn_back_luas);
        ...
        btn_convert = findViewById(R.id.btn_convert_luas);
        txt_input = findViewById(R.id.txt_input_luas);
        tv_output = findViewById(R.id.tv_output_luas);

        autoComplete1Txt = findViewById(R.id.autoComplete1_txt_luas);
        autoComplete2Txt = findViewById(R.id.autoComplete2_txt_luas);
    ...
    // all to Hektar
    private double KMtoHektar(double km) {
        return km * 100;
    }
    private double MtoHektar(double m) {
        return m / 10000;
    }
    private double CMtoHektar(double cm) {
        return cm / 100000000;
    }

    // Hektar to all
    private double HektartoKM(double Hektar) {
        return Hektar / 100;
    }
    private double HektartoM(double Hektar) {
        return Hektar * 10000;
    }
    private double HektartoCM(double Hektar) {
        return Hektar * 100000000;
    }
